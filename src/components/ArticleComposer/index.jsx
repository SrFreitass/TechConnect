...
import { CloudArrowDown, TrashSimple, NotePencil, Bookmarks, Tag } from "@phosphor-icons/react";
...
export function ArticleCreationForm() {
    ...
    const onInitEditor = (evt, editor) => {
        document.querySelector('iframe').contentWindow.document.body.style.backgroundColor = '#121212'
            ...
            <StyleArticleCreationForm>
                <form>
                    <div>
                            ...
                            <IconsContainer>
                                <button onClick={handleImageDelete}> <TrashSimple size={24} color="#8A8AE0" /> </button>
